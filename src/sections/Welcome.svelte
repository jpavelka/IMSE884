...
<BodyText>
    There are a few other sources that I recommend, whose contents is woven into this course. I have to start with the book <Key><em>Integer and Combinatorial Optimization</em> <CitationRef refId=nemWol1999/></Key>, written by Wolsey along with George Nemhauser, which is <Key>potentially <em>the</em> reference for this subject<Footnote>
        Why didn't I choose <CitationRef refId=nemWol1999/> as the course text? I think the presentation and level of <CitationRef refId=wolsey2020/> is a little better suited for this course. It's also a bit newer, and although the theory found in <CitationRef refId=nemWol1999/> is evergreen, <CitationRef refId=wolsey2020/> contains a bit more updated information on techniques used by solvers in practice today.
...
<BodyText>
    <Key>These notes were created for educational use. With proper attribution,
    readers may freely copy, distribute, or produce derivative work from this
    content, in whole or in part, for any non-commercial use.</Key>
</BodyText>
